    ...
    <main className="min-h-screen px-6 py-12">
      <div className="mx-auto max-w-4xl space-y-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="font-display text-2xl font-bold text-sand-light">Configurações da loja</h1>
            ...
            <div className="mt-5">
              ...
              <div className="mt-2.5 flex flex-wrap items-center gap-4">
                {form.crestUrl ? (
                  ...
                  <div className="flex h-16 w-16 items-center justify-center rounded-lg border border-dashed border-white/15 text-xs text-sand-dark">Sem brasão</div>
                )}
