...
export default function FechamentoClient({ data, initialFrom, initialTo }: { data: Closing; initialFrom: string; initialTo: string }) {
  ...
  const maxRD = Math.max(1, ...data.receitasDespesas.flatMap((m) => [m.receita, m.despesa]));
