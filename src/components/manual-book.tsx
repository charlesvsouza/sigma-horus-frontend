          ...
          <article className="manual-print min-w-0 space-y-12">
            ...
            <Chapter id="tesoureiro" num="7" title="Guia do Tesoureiro">
              ...
              <Sub id="tes-razao" title="7.18 Razão por categoria">
                ...
                <Bullets>
                  <li><strong>Categorias:</strong> marque uma, várias ou nenhuma (nenhuma = todas). Os atalhos <UI>Só Mensalidades</UI>, <UI>Só o Tronco</UI> e <UI>Só Doações e Contribuições</UI> já marcam de uma vez as categorias certas — os dois últimos marcam <strong>todas as categorias daquele fundo</strong>, receita e despesa juntas (ex.: Tronco de Beneficência + Ação Social e Caridade), não só uma. Categoria marcada sem nenhum lançamento no período aparece mesmo assim, com <strong>&quot;Sem movimentação no período selecionado&quot;</strong> no lugar da tabela — assim dá pra confirmar que o filtro considerou a categoria, só não achou nada nela ainda.</li>
