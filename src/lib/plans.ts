...
export const PLANS = {
  oficina: {
    ...
    features: [
      ...
      'Gestão financeira completa (contas, boletos e Pix via Asaas)',
      'Relatórios inteligentes (DRE, balancetes, fluxo de caixa, orçamento e mais)',
      'Módulo Social (quadro social, composição, galeria de veneráveis)',
      'Hospitalaria (Tronco de Beneficência e campanhas)',
  ...
  potencia: {
    ...
    rank: 3,
    maxMembers: Infinity,
    description: 'Para lojas com mais de 80 membros ativos.',
    features: [
      'Membros ilimitados',
      'Tudo do plano Loja',
      'Onboarding dedicado',
